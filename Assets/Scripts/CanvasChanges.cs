...
public class CanvasChanges : MonoBehaviour
{
    ...
    public void Reset_RedCubeXYZ()
    {
        ...
        RedCube.transform.localPosition = new Vector3(-float.Parse(redcube_pos_x.text), float.Parse(redcube_pos_z.text), -float.Parse(redcube_pos_y.text));
    }
    // Red cube Rotation
    public void Reset_RedCubeXYZ_rot()
    {
        ...
        RedCube.transform.localRotation = Quaternion.Euler(float.Parse(redcube_rot_x.text), float.Parse(redcube_rot_z.text), float.Parse(redcube_rot_y.text));
    }
    ...
    public void Reset_GreenCubeXYZ()
    {
        ...
        GreenCube.transform.localPosition = new Vector3(-float.Parse(greencube_pos_x.text), float.Parse(greencube_pos_z.text), -float.Parse(greencube_pos_y.text));
    }
    // Green cube Rotation
    public void Reset_GreenCubeXYZ_rot()
    {
        ...
        GreenCube.transform.localRotation = Quaternion.Euler(float.Parse(greencube_rot_x.text), float.Parse(greencube_rot_z.text), float.Parse(greencube_rot_y.text));
    }
    ...
    public void Reset_BlueCubeXYZ()
    {
        ...
        BlueCube.transform.localPosition = new Vector3(-float.Parse(bluecube_pos_x.text), float.Parse(bluecube_pos_z.text), -float.Parse(bluecube_pos_y.text));
    }
    // Blue cube Rotation
    public void Reset_BlueCubeXYZ_rot()
    {
        ...
        BlueCube.transform.localRotation = Quaternion.Euler(float.Parse(bluecube_rot_x.text), float.Parse(bluecube_rot_z.text), float.Parse(bluecube_rot_y.text));
    }
}
